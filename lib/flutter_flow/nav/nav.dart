      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Challenge_Main')
              : ChallengeMainWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Personal_Card',
          path: '/personalCard',
          builder: (context, params) => PersonalCardWidget(),
        ),
        FFRoute(
          name: 'QR_Scan',
          path: '/qRScan',
        ...
        FFRoute(
          name: 'PaymentSuccesfulPage',
          path: '/paymentSuccesfulPage',
          builder: (context, params) => PaymentSuccesfulPageWidget(),
        ),
        FFRoute(
          name: 'articlepageCopy',
          path: '/articlepageCopy',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'articlepageCopy')
              : ArticlepageCopyWidget(),
        ),
        FFRoute(
