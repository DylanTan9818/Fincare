...
import 'schema/challenge_mapping_record.dart';
...
export 'schema/challenge_mapping_record.dart';
...
/// Functions to query ChallengeMappingRecords (as a Stream and as a Future).
Future<int> queryChallengeMappingRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChallengeMappingRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChallengeMappingRecord>> queryChallengeMappingRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChallengeMappingRecord.collection,
      ChallengeMappingRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChallengeMappingRecord>> queryChallengeMappingRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
